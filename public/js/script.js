...
var vm = new Vue({
	...
	RemoveUser: function (id) {
		var ConfirmBox = confirm("Apakah anda yakin akan menghapus data tersebut?")
	...
	EditUser: function (id) {
		...
		this.newUser = { id: '', name: '', email: '', address: '', telp: '', pesan:'' }
	...
	ShowUser: function (id) {
		...
		this.$http.get('/api/users/' + id, function (data) {
			...
			this.newUser.telp = data.telp
			this.newUser.pesan = data.pesan
		})
	},
	...
	AddNewUser: function () {
			...
			// Clear form input
			this.newUser = { name:'', email:'', address:'', telp:'', pesan:'' }
